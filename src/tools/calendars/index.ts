...
export function registerCalendarsTools(server: McpServer): void {
        ...
        'calendars_list',
        {
            ...
            inputSchema: {
                ...
                groupId: z
                    .string()
                    .optional()
                    .describe('Filter by calendar group ID'),
                showDrafted: z
                    .boolean()
                    .optional()
                    .describe('Include drafted calendars')
            },
            annotations: {
        ...
        'calendars_create',
        {
            ...
            inputSchema: {
                ...
                slotDuration: z
                    .number()
                    .optional()
                    .describe('Slot duration in minutes'),
                slotBuffer: z
                    .number()
                    .optional()
                    .describe('Buffer between slots in minutes'),
                slotInterval: z
                    .number()
                    .optional()
                ...
                preBuffer: z
                    .number()
                    .optional()
                    .describe('Pre-buffer time in minutes'),
                appoinmentPerSlot: z
                    .number()
                    .optional()
                    .describe('Appointments per slot'),
                appoinmentPerDay: z
                    .number()
                    .optional()
                    .describe('Max appointments per day'),
                openHours: z
                ...
                enableRecurring: z
                    .boolean()
                    .optional()
                    .describe('Enable recurring appointments'),
                formId: z.string().optional().describe('Form ID'),
                stickyContact: z
                    .boolean()
                    .optional()
                    .describe('Sticky contact flag'),
                isLivePaymentMode: z
                    .boolean()
                    .optional()
                    .describe('Live payment mode'),
                autoConfirm: z
                    .boolean()
                    .optional()
                    .describe('Auto-confirm appointments'),
                consentLabel: z
                    .string()
                    .optional()
                    .describe('Consent label text'),
                calendarCoverImage: z
                    .string()
                    .optional()
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error getting slots: ${error.message}`
                        }
                    ]
                };
            }
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error getting calendar groups: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().calendars.createCalendarGroup(
                        stripUndefined(params)
                    );
                return {
                    content: [
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error creating calendar group: ${error.message}`
                        }
                    ]
                };
            }
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error deleting calendar group: ${error.message}`
                        }
                    ]
                };
            }
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error editing calendar group: ${error.message}`
                        }
                    ]
                };
            }
        ...
        'calendars_create_appointment',
        {
            ...
            inputSchema: {
                ...
                ignoreDateRange: z
                    .boolean()
                    .optional()
                    .describe('Ignore date range validation'),
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error editing appointment: ${error.message}`
                        }
                    ]
                };
            }
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error getting appointment: ${error.message}`
                        }
                    ]
                };
            }
            ...
            try {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error creating block slot: ${error.message}`
                        }
                    ]
                };
            }

...
export function registerFunnelsTools(server: McpServer): void {
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing funnels: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing funnel pages: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing redirects: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().funnels.createRedirect(params);
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                };
            } catch (error: any) {
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error creating redirect: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error updating redirect: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().funnels.deleteRedirectById(params);
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                };
            } catch (error: any) {
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error deleting redirect: ${error.message}` }],
                };
            }
        }
    );

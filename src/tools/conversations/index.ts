...
export function registerConversationsTools(server: McpServer): void {
    ...
    server.registerTool(
        'conversations_search',
        {
            ...
            inputSchema: {
                ...
                lastMessageType: z
                    .string()
                    .optional()
                    .describe('Filter by last message type')
            },
            annotations: {
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.searchConversation(
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.getConversation({
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.createConversation(
                        params
                    );
                return {
                    content: [
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error creating conversation: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        'conversations_update',
        {
            ...
            inputSchema: {
                ...
                starred: z
                    .boolean()
                    .optional()
                    .describe('Whether the conversation is starred'),
                unreadCount: z
                    .number()
                    .optional()
        ...
        async params => {
            try {
                ...
                const result =
                    await getGhlClient().conversations.updateConversation(
                        { conversationId },
                        stripUndefined(body)
                    );
                return {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error updating conversation: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.deleteConversation({
                        conversationId: params.conversationId
                    });
                return {
                    content: [
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error deleting conversation: ${error.message}`
                        }
                    ]
                };
            }
        ...
        'conversations_getMessages',
        {
            ...
            inputSchema: {
                ...
                lastMessageId: z
                    .string()
                    .optional()
                    .describe('ID of the last message for pagination'),
                limit: z
                    .number()
                    .optional()
    ...
    server.registerTool(
        'conversations_sendMessage',
        {
            ...
            inputSchema: {
                type: z
                    .string()
                    .describe('Message type (e.g. SMS, Email, WhatsApp)'),
                contactId: z.string().describe('The contact ID'),
                ...
                conversationProviderId: z
                    .string()
                    .optional()
                    .describe('Conversation provider ID'),
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.sendANewMessage(
                        stripUndefined(params)
                    );
                return {
                    content: [
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.addAnInboundMessage(
                        params
                    );
                return {
                    content: [
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error adding inbound message: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.cancelScheduledMessage({
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error cancelling scheduled message: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        'conversations_updateMessageStatus',
        {
            ...
            inputSchema: {
                ...
                error: z
                    .string()
                    .optional()
                    .describe('Error message if applicable')
            },
            annotations: {
        ...
        async params => {
            try {
                ...
                const result =
                    await getGhlClient().conversations.updateMessageStatus(
                        { messageId },
                        stripUndefined(body)
                    );
                return {
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error updating message status: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.getMessageRecording({
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error getting message recording: ${error.message}`
                        }
                    ]
                };
            }
    ...
    server.registerTool(
        'conversations_uploadFileAttachments',
        {
            ...
            inputSchema: {
                ...
                attachmentUrl: z
                    .string()
                    .describe('URL of the attachment to upload')
            },
            annotations: {
        ...
        async params => {
            try {
                const result =
                    await getGhlClient().conversations.uploadFileAttachments(
                        params
                    );
                return {
                    content: [
                ...
                return {
                    ...
                    content: [
                        {
                            type: 'text' as const,
                            text: `Error uploading file attachment: ${error.message}`
                        }
                    ]
                };
            }

...
export function registerSocialMediaTools(server: McpServer): void {
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.getGoogleLocations({
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting Google Business locations: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'social-media_set-google-locations',
        {
            ...
            inputSchema: {
                locationId: z.string().describe('The location ID'),
                accountId: z.string().describe('The Google account ID'),
                location: z.record(z.string(), z.any()).optional().describe('Google Business location object'),
                account: z.record(z.string(), z.any()).optional().describe('Google account object'),
        ...
        async (params) => {
            try {
                ...
                const result = await getGhlClient().socialMediaPosting.setGoogleLocations(
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error setting Google Business locations: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.getAccount({
                    locationId: params.locationId,
                });
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting social media accounts: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'social-media_search-posts',
        {
            ...
            inputSchema: {
                ...
                accounts: z.string().optional().describe('Comma-separated account IDs'),
                skip: z.string().optional().describe('Number of records to skip (as string)'),
                limit: z.string().optional().describe('Maximum number of results (as string)'),
                fromDate: z.string().optional().describe('Start date filter (ISO string)'),
                toDate: z.string().optional().describe('End date filter (ISO string)'),
                includeUsers: z.string().optional().describe('Whether to include user details'),
    ...
    server.registerTool(
        'social-media_create-post',
        {
            ...
            inputSchema: {
                locationId: z.string().describe('The location ID'),
                accountIds: z.array(z.string()).describe('Array of account IDs to post to'),
                ...
                scheduleDate: z.string().optional().describe('Scheduled publish date (ISO string)'),
                status: z.string().optional().describe('Post status'),
                tags: z.array(z.string()).optional().describe('Tags for the post'),
                categoryId: z.string().optional().describe('Category ID for the post'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                const { locationId, ...body } = params;
                const result = await getGhlClient().socialMediaPosting.createPost(
                    { locationId },
                    stripUndefined(body) as any
                );
                return {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error creating post: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting post: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'social-media_edit-post',
        {
            ...
            inputSchema: {
                id: z.string().describe('The post ID'),
                locationId: z.string().describe('The location ID'),
                accountIds: z.array(z.string()).optional().describe('Array of account IDs'),
                summary: z.string().optional().describe('Post content/summary'),
                media: z
                    .array(z.record(z.string(), z.any()))
                    .optional()
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error editing post: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.deletePost({
                    id: params.id,
                    locationId: params.locationId,
                });
                return {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error deleting post: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.getCsvPost(
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting CSV report: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'social-media_get-categories',
        {
            ...
            inputSchema: {
                locationId: z.string().describe('The location ID'),
                searchText: z.string().optional().describe('Search text to filter categories'),
                limit: z.string().optional().describe('Maximum number of results'),
                skip: z.string().optional().describe('Number of records to skip'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.getCategoriesLocationId(
                    stripUndefined(params)
                );
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting categories: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'social-media_get-tags',
        {
            ...
            inputSchema: {
                locationId: z.string().describe('The location ID'),
                searchText: z.string().optional().describe('Search text to filter tags'),
                limit: z.string().optional().describe('Maximum number of results'),
                skip: z.string().optional().describe('Number of records to skip'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                const result = await getGhlClient().socialMediaPosting.getTagsLocationId(
                    stripUndefined(params)
                );
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting tags: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const { locationId, ...body } = params;
                const result = await getGhlClient().socialMediaPosting.getTagsByIds(
                    { locationId },
                    stripUndefined(body) as any
                );
                return {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting tags by IDs: ${error.message}` }],
                };
            }
        }
    );

...
export function registerPaymentsTools(server: McpServer): void {
    ...
    server.registerTool(
        'payments_listOrders',
        {
            ...
            inputSchema: {
                ...
                funnelProductIds: z.string().optional().describe('Funnel product IDs filter'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing orders: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting order: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'payments_listTransactions',
        {
            ...
            inputSchema: {
                ...
                paymentMode: z.string().optional().describe('Filter by payment mode'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing transactions: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting transaction: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing subscriptions: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().payments.getSubscriptionById({
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting subscription: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                const result = await getGhlClient().payments.listIntegrationProviders(
                    stripUndefined(params)
                );
                return {
                    content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }],
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error listing payment integrations: ${error.message}` }],
                };
            }
        }
    );

    ...
    server.registerTool(
        'medias_list',
        {
            ...
            inputSchema: {
                ...
                fetchAll: z.string().optional().describe('Whether to fetch all results'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting media files: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error deleting media file: ${error.message}` }],
                };
            }
        }
    );

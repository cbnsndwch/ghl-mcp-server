...
export function registerObjectsTools(server: McpServer): void {
    ...
    server.registerTool(
        'objects_get-by-key',
        {
            ...
            inputSchema: {
                ...
                fetchProperties: z.string().optional().describe('Whether to fetch properties'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                const result = await getGhlClient().objects.getObjectSchemaByKey(
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting object: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'objects_search-records',
        {
            ...
            inputSchema: {
                schemaKey: z.string().optional().describe('The object schema key'),
                locationId: z.string().describe('The location ID'),
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error searching object records: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error getting object record: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'objects_create-record',
        {
            ...
            inputSchema: {
                schemaKey: z.string().describe('The object schema key'),
                locationId: z.string().describe('The location ID'),
                properties: z.record(z.string(), z.any()).optional().describe('Record properties'),
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error creating object record: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        'objects_update-record',
        {
            ...
            inputSchema: {
                ...
                id: z.string().describe('The record ID'),
                locationId: z.string().describe('The location ID'),
                properties: z.record(z.string(), z.any()).optional().describe('Record properties to update'),
                owners: z.array(z.string()).optional().describe('Array of owner IDs'),
            },
            annotations: {
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error updating object record: ${error.message}` }],
                };
            }
        }
    );
    ...
    server.registerTool(
        ...
        async (params) => {
            try {
                ...
                return {
                    isError: true,
                    content: [{ type: 'text' as const, text: `Error deleting object record: ${error.message}` }],
                };
            }
        }
    );
